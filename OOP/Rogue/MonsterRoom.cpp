...
MonsterRoom::MonsterRoom() {
	...
	mMonsterType = monsters(GetRandomEngine());
}
...
vector<string> MonsterRoom::GetActions() const {
	vector<string> actions = { 
		"Run away!!!",
		"Curl up in a ball and hope it ignores you." 
	};
	switch (mMonsterType) {
	case 0:
		actions.push_back("Spray it with RAAAAAAID.");
		break;

	case 1:
		actions.push_back("Call the Ghostbusters.");
		break;

	case 2:
		actions.push_back("Seduce the dragon.");
		actions.push_back("Accept your mortal fate.");
		break;
	}
	return actions;
}
